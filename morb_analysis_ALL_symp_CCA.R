...
#prev CCA positive only with symtpoms
rm(list = ls())
...
Symp <- 
  data %>%
  dplyr::select(MalariaYN, CCA_pos,
...
#
model <-glm(symptoms.blood_stool~ CCA_pos+HW_pos+MalariaYN+age, family=binomial, data=Symp)
summary(model)
#
#"symptoms.diarrhoea", ##########################
...
#REML
mod4 <- gam(symptoms.diarrhoea ~ 
              s(age, bs="ps") + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial", method = "REML")
#sp=0.1
mod5 <- gam(symptoms.diarrhoea ~ 
              s(age, bs="ps", sp=0.1) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
#sp=1
mod6 <- gam(symptoms.diarrhoea ~ 
              s(age, bs="ps", sp=1) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")

#sp=2
mod7 <- gam(symptoms.diarrhoea ~ 
              s(age, bs="ps", sp=2) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
...
summary(mod4) #age, hw borderline
...
mod5 <- gam(symptoms.blood_stool ~ 
              s(age, bs="cr", sp=0.1, k=25) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
#sp=1
mod6 <- gam(symptoms.blood_stool ~ 
              s(age, bs="cr", sp=1) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")

#sp=2
mod7 <- gam(symptoms.blood_stool ~ 
              s(age, bs="cr", sp=2) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
...
mod5 <- gam(symptoms.pain_urine ~ 
              s(age, bs="cr", sp=0.1) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
#sp=1
...
#use AIC test to compare models
AIC(mod4,mod5,mod6, mod7) #mod4 wins 
...
summary(mod4) #age, malria moderate
...
#use AIC test to compare models
AIC(mod4,mod5,mod6, mod7) #mod 4 wins just
...
summary(mod5s) #age, nearky CCA_pos

#sp=0.1
mod5s <- gam(symptoms.rash  ~ 
              s(age, bs="cr", sp=0.1) + HW_pos + MalariaYN+CCA_pos+sex,
            data = Symp, family = "binomial")
...
mod5 <- gam(symptoms.muscle_pain  ~ 
              s(age, bs="tp", sp=0.1) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
#sp=1
mod6 <- gam(symptoms.muscle_pain  ~ 
              s(age, bs="tp", sp=1) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")

#sp=2
mod7 <- gam(symptoms.muscle_pain  ~ 
              s(age, bs="tp", sp=2) + HW_pos + MalariaYN+CCA_pos,
            data = Symp, family = "binomial")
...
plot(simulateResiduals(mod6)) #good use this


summary(mod6) #age, nearly negative effect with malaria
...
#use AIC test to compare models
AIC(mod4,mod5,mod6, mod7) #mod 7 wins but is very close to mod4,so choose that
